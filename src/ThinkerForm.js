class ThinkerForm {
    ...
    static thinkerFormContent(editThinkerForm, name, image,  times_studied, category, thinkerForm){
    ...
    static ThinkerEditHandler(editBtn, editThinkerForm, name, image,  times_studied, category){
      editBtn.addEventListener("click", () => {
        modal.style.display = "block"
        modalContent.append(editThinkerForm)
        ThinkerForm.thinkerFormContent(editThinkerForm, name, image, times_studied, category)
      })
    }
